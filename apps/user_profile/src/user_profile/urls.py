...
urlpatterns = patterns('user_profile',
  ...
  # url(r'^_tag_heat', TemplateView.as_view(template_name='user_profile/hot_statis.html')),
  url(r'^_tag_heat/?$', 'views.financial'),
  url(r'^_tag_heat/(?P<pcode>[0-9a-zA-Z]+)/$', 'views.financial'),
  url(r'^tag_search', 'views.tag_search'),
